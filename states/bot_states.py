...
class BotStates(StatesGroup):
    ...
    # выбор категории при создании партнёра
    waiting_restaurant_category = State()
    ...
    # Выбор ресторана для управления модераторами
    waiting_moderator_restaurant_selection = State()
    ...
    waiting_events_bali_region = State()
    waiting_events_bali_title = State()
    waiting_events_bali_description = State()
